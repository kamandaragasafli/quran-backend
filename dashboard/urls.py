...
urlpatterns = [
    ...
    path('privacy/', views.privacy_public, name='privacy-public'),
    path('privacy/edit/', views.privacy_content, name='dash-privacy'),
    path('gizlilik/', views.privacy_public_redirect),
    path('gizlilik/redakte/', views.privacy_edit_redirect),
